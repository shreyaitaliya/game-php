...
<body>
    <main class="d-flex">
        ...
        <div class="main w-full px-12 py-6">
            ...
            <form method="post" action="functions/api" class="w-full">
                    ...
                    <div class="specific-div">
                        ...
                        <div class="flex gap-5 mt-6">
                            ...
                            <div class="input-group w-full flex flex-column">
                                ...
                                <input type="number" name="page" class="py-[15px] text-gray-500 outline-none focus:outline focus:outline-blue-500 transition-sm  px-3 text-xs" minlength="1" value="1">
                            </div>
                        </div>
