                    ...
                    <div class="flex gap-6">
                        ...
                        <div class="input-form w-full">
                            ...
                            <div class="input-group flex flex-column mt-6">
                                ...
                                <input required value="<?php if(!empty($token_id)) { echo $data['game_description']; } ?>" name="game_description" class="py-[15px] text-gray-500 outline-none focus:outline focus:outline-blue-500 transition-sm  px-3 text-xs" type="text" placeholder="Description">
                            </div>
