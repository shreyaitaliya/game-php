                    ...
                    <div class="flex gap-6">
                        <div class="input-form w-full">
                            ...
                            <div class="input-group flex flex-column mt-6">
                                ...
                                <textarea name="ad_code" class="outline-none px-2 py-2 focus:outline-blue-500 transition-sm text-gray-500 text-sm" cols="30" rows="10"><?php if(!empty($token_id)) { echo $data['code']; } ?></textarea>
                            </div>
